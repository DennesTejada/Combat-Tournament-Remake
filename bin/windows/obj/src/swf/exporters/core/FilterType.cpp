...
::swf::exporters::core::FilterType FilterType_obj::BlurFilter(Float blurX,Float blurY,int quality)
{
	return ::hx::CreateEnum< FilterType_obj >(HX_("BlurFilter",df,d1,71,f3),0,3)->_hx_init(0,blurX)->_hx_init(1,blurY)->_hx_init(2,quality);
}

::swf::exporters::core::FilterType FilterType_obj::ColorMatrixFilter(::Array< Float > matrix)
{
	return ::hx::CreateEnum< FilterType_obj >(HX_("ColorMatrixFilter",bc,f6,5b,50),1,1)->_hx_init(0,matrix);
}

::swf::exporters::core::FilterType FilterType_obj::DropShadowFilter(Float distance,Float angle,int color,Float alpha,Float blurX,Float blurY,Float strength,int quality,bool inner,bool knockout,bool hideObject)
{
...
::swf::exporters::core::FilterType FilterType_obj::GlowFilter(int color,Float alpha,Float blurX,Float blurY,Float strength,int quality,bool inner,bool knockout)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("swf.exporters.core.FilterType",39,17,82,d5), ::hx::TCanCast< FilterType_obj >,FilterType_obj_sStaticFields,0,

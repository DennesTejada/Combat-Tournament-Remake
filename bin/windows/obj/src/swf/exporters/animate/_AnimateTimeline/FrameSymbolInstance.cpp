...
HX_DEFINE_STACK_FRAME(_hx_pos_0201417d597d84ce_564_new,"swf.exporters.animate._AnimateTimeline.FrameSymbolInstance","new",0xc9ac87b6,"swf.exporters.animate._AnimateTimeline.FrameSymbolInstance.new","swf/exporters/animate/AnimateTimeline.hx",564,0x1283a6b4)
namespace swf{
namespace exporters{
namespace animate{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_0201417d597d84ce_564_new)
HXLINE( 565)		this->initFrame = initFrame;
HXLINE( 566)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 567)		this->characterID = characterID;
HXLINE( 568)		this->depth = depth;
HXLINE( 569)		this->displayObject = displayObject;
HXLINE( 570)		this->clipDepth = clipDepth;
            	}
...
bool FrameSymbolInstance_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7cfe9306;
}
...
::hx::ObjectPtr< FrameSymbolInstance_obj > FrameSymbolInstance_obj::__alloc(::hx::Ctx *_hx_ctx,int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth) {
	FrameSymbolInstance_obj *__this = (FrameSymbolInstance_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FrameSymbolInstance_obj), true, "swf.exporters.animate._AnimateTimeline.FrameSymbolInstance"));
...
void FrameSymbolInstance_obj::__register()
{
	...
	__mClass->mName = HX_("swf.exporters.animate._AnimateTimeline.FrameSymbolInstance",c4,34,bd,d7);

...
HX_DEFINE_STACK_FRAME(_hx_pos_328c59b03f9bae44_27_new,"swf.exporters.animate.AnimateFrameObject","new",0x01663d92,"swf.exporters.animate.AnimateFrameObject.new","swf/exporters/animate/AnimateFrameObject.hx",27,0x9f24f3fb)
namespace swf{
namespace exporters{
namespace animate{
...
bool AnimateFrameObject_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x6ea0ea7c;
}
...
void AnimateFrameObject_obj::__register()
{
	...
	__mClass->mName = HX_("swf.exporters.animate.AnimateFrameObject",a0,cc,b7,dc);

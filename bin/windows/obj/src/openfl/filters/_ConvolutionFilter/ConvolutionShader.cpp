...
HX_DEFINE_STACK_FRAME(_hx_pos_5054037a2bd70aa6_350_new,"openfl.filters._ConvolutionFilter.ConvolutionShader","new",0x1c2c8ac3,"openfl.filters._ConvolutionFilter.ConvolutionShader.new","openfl/filters/ConvolutionFilter.hx",350,0x8cb91f21)
...
void ConvolutionShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_5054037a2bd70aa6_350_new)
...
HXLINE( 354)		this->uDivisor->value = ::Array_obj< Float >::fromData( _hx_array_data_f8416d51_1,1);
HXLINE( 355)		this->uBias->value = ::Array_obj< Float >::fromData( _hx_array_data_f8416d51_2,1);
HXLINE( 356)		this->uPreserveAlpha->value = ::Array_obj< bool >::fromData( _hx_array_data_f8416d51_3,1);
HXLINE( 276)		this->_hx___isGenerated = true;
HXDLIN( 276)		this->_hx___initGL();
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_603da0a459dc1a0e_447_new,"openfl.filters._DisplacementMapFilter.DisplacementMapShader","new",0xcc3525dd,"openfl.filters._DisplacementMapFilter.DisplacementMapShader.new","openfl/filters/DisplacementMapFilter.hx",447,0x81237e14)
namespace openfl{
namespace filters{
namespace _DisplacementMapFilter{

void DisplacementMapShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_603da0a459dc1a0e_447_new)
...
HXLINE( 448)		super::__construct(null());
HXLINE( 393)		this->_hx___isGenerated = true;
HXDLIN( 393)		this->_hx___initGL();
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_1b07d5ba1db1ad5b_118_update,"engine.PlayerDefault","update",0x3c03e1a3,"engine.PlayerDefault.update","engine/PlayerDefault.hx",118,0xa5c233ab)
HX_LOCAL_STACK_FRAME(_hx_pos_1b07d5ba1db1ad5b_228_jumpUp,"engine.PlayerDefault","jumpUp",0xbd160283,"engine.PlayerDefault.jumpUp","engine/PlayerDefault.hx",228,0xa5c233ab)
HX_LOCAL_STACK_FRAME(_hx_pos_1b07d5ba1db1ad5b_239_turnRight,"engine.PlayerDefault","turnRight",0x3fcb2bc5,"engine.PlayerDefault.turnRight","engine/PlayerDefault.hx",239,0xa5c233ab)
HX_LOCAL_STACK_FRAME(_hx_pos_1b07d5ba1db1ad5b_242_turnLeft,"engine.PlayerDefault","turnLeft",0xbf77183e,"engine.PlayerDefault.turnLeft","engine/PlayerDefault.hx",242,0xa5c233ab)
namespace engine{
...
HXLINE( 103)		bool hitbox1 = hitbox->isLauncher;
HXLINE( 106)		Float _hx_tmp = playerWhoHitMe->get_x();
HXDLIN( 106)		if ((_hx_tmp > this->get_x())) {
HXLINE( 107)			this->turnRight();
            		}
HXLINE( 109)		Float _hx_tmp1 = playerWhoHitMe->get_x();
HXDLIN( 109)		if ((_hx_tmp1 < this->get_x())) {
HXLINE( 110)			this->turnLeft();
            		}
HXLINE( 112)		 ::Dynamic this1 =  ::Dynamic(::hx::Anon_obj::Create(0));
HXDLIN( 112)		 ::Dynamic eventObj = this1;
HXLINE( 113)		{
HXLINE( 113)			 ::Dynamic this2 = eventObj;
HXDLIN( 113)			if (::hx::IsNotNull( this2 )) {
HXLINE( 113)				::Reflect_obj::setProperty(this2,HX_("victim",88,fd,f7,e4),::hx::ObjectPtr<OBJ_>(this));
            			}
            		}
HXLINE( 114)		{
HXLINE( 114)			 ::Dynamic value = hitbox->hitter;
HXDLIN( 114)			{
HXLINE( 114)				 ::Dynamic this3 = eventObj;
HXDLIN( 114)				if (::hx::IsNotNull( this3 )) {
HXLINE( 114)					::Reflect_obj::setProperty(this3,HX_("hitter",6e,8d,35,57),value);
            				}
            			}
            		}
HXLINE( 115)		{
HXLINE( 115)			 ::Dynamic value1 = hitbox->isLauncher;
HXDLIN( 115)			{
HXLINE( 115)				 ::Dynamic this4 = eventObj;
HXDLIN( 115)				if (::hx::IsNotNull( this4 )) {
HXLINE( 115)					::Reflect_obj::setProperty(this4,HX_("isLauncher",6a,9f,2d,bd),value1);
            				}
            			}
            		}
HXLINE( 116)		this->dispatchEvent( ::engine::events::CharacterStateEvent_obj::__alloc( HX_CTX ,::engine::events::CharacterStateEvent_obj::ON_GOT_HIT,eventObj));
            	}
...
void PlayerDefault_obj::update( ::engine::events::GameEvent e){
            	HX_GC_STACKFRAME(&_hx_pos_1b07d5ba1db1ad5b_118_update)
HXLINE( 119)		this->getInputs();
HXLINE( 123)		if (::hx::IsPointerEq( this->state,::engine::States_obj::FREE_dyn() )) {
HXLINE( 124)			this->gravity = ((Float)0.5);
HXLINE( 125)			this->canMove = true;
HXLINE( 126)			this->canAttack = true;
HXLINE( 127)			this->canJump = true;
HXLINE( 128)			this->canAirJump = !(this->onground);
            		}
HXLINE( 130)		if (::hx::IsPointerEq( this->state,::engine::States_obj::ATTACK_dyn() )) {
HXLINE( 131)			this->canMove = !(this->onground);
HXLINE( 132)			this->canJump = false;
HXLINE( 133)			this->canAirJump = false;
            		}
HXLINE( 135)		if (::hx::IsPointerEq( this->state,::engine::States_obj::START_JUMP_dyn() )) {
HXLINE( 136)			this->canMove = false;
HXLINE( 137)			this->canAttack = true;
HXLINE( 138)			this->canJump = false;
HXLINE( 139)			this->canAirJump = false;
            		}
HXLINE( 142)		if (this->canMove) {
HXLINE( 143)			this->maxXspeed = ( (Float)(10) );
HXLINE( 144)			if (!(this->onground)) {
HXLINE( 145)				this->friction = ((Float).95);
HXLINE( 146)				if (this->RIGHT) {
HXLINE( 147)					 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 147)					_hx_tmp->xspeed = (_hx_tmp->xspeed + this->airMoveSpeed);
            				}
HXLINE( 149)				if (this->LEFT) {
HXLINE( 150)					 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 150)					_hx_tmp->xspeed = (_hx_tmp->xspeed - this->airMoveSpeed);
            				}
HXLINE( 152)				if ((this->yspeed > 0)) {
HXLINE( 153)					this->changeCharState(::engine::events::CharacterStateEvent_obj::JUMP_DOWN);
            				}
            				else {
HXLINE( 155)					this->changeCharState(::engine::events::CharacterStateEvent_obj::JUMP_UP);
            				}
            			}
HXLINE( 158)			if (this->onground) {
HXLINE( 159)				this->friction = ((Float).7);
HXLINE( 160)				if (this->RIGHT) {
HXLINE( 161)					 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 161)					_hx_tmp->xspeed = (_hx_tmp->xspeed + this->runSpeed);
HXLINE( 162)					this->turnRight();
HXLINE( 163)					this->changeCharState(::engine::events::CharacterStateEvent_obj::RUN);
            				}
            				else {
HXLINE( 164)					if (this->LEFT) {
HXLINE( 165)						 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 165)						_hx_tmp->xspeed = (_hx_tmp->xspeed - this->runSpeed);
HXLINE( 166)						this->turnLeft();
HXLINE( 167)						this->changeCharState(::engine::events::CharacterStateEvent_obj::RUN);
            					}
            					else {
HXLINE( 168)						if (this->DOWN) {
HXLINE( 169)							this->changeCharState(::engine::events::CharacterStateEvent_obj::DUCK);
            						}
            						else {
HXLINE( 171)							this->changeCharState(::engine::events::CharacterStateEvent_obj::STANCE);
            						}
            					}
            				}
            			}
...
HXLINE( 177)			if ((this->xspeed < -(this->maxXspeed))) {
HXLINE( 178)				this->xspeed = -(this->maxXspeed);
            			}
            		}
HXLINE( 181)		if (this->canJump) {
HXLINE( 182)			bool _hx_tmp;
HXDLIN( 182)			if (this->JUMP_PRESSED) {
HXLINE( 182)				_hx_tmp = this->onground;
            			}
            			else {
HXLINE( 182)				_hx_tmp = false;
            			}
HXDLIN( 182)			if (_hx_tmp) {
HXLINE( 183)				this->state = ::engine::States_obj::START_JUMP_dyn();
HXLINE( 184)				this->changeCharState(::engine::events::CharacterStateEvent_obj::START_JUMP);
            			}
            		}
HXLINE( 187)		if (this->canAirJump) {
HXLINE( 188)			if (this->JUMP_PRESSED) {
HXLINE( 189)				this->jumpUp(( (Float)(this->jumpPower) ));
            			}
            		}
HXLINE( 195)		this->onground = false;
HXLINE( 196)		this->onrightWall = false;
HXLINE( 197)		this->onleftWall = false;
HXLINE( 198)		 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 198)		_hx_tmp->xspeed = (_hx_tmp->xspeed * this->friction);
HXLINE( 199)		 ::engine::PlayerDefault _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 199)		_hx_tmp1->yspeed = (_hx_tmp1->yspeed + this->gravity);
HXLINE( 200)		while(true){
HXLINE( 200)			 ::openfl::display::Sprite _hx_tmp = this->mapCollision;
HXDLIN( 200)			Float _hx_tmp1 = (this->get_x() - ( (Float)(30) ));
HXDLIN( 200)			if (!(_hx_tmp->hitTestPoint(_hx_tmp1,this->get_y(),true))) {
HXLINE( 200)				goto _hx_goto_4;
            			}
HXLINE( 201)			this->set_x((this->get_x() + 1));
            		}
            		_hx_goto_4:;
HXLINE( 203)		while(true){
HXLINE( 203)			 ::openfl::display::Sprite _hx_tmp = this->mapCollision;
HXDLIN( 203)			Float _hx_tmp1 = (this->get_x() + 30);
HXDLIN( 203)			if (!(_hx_tmp->hitTestPoint(_hx_tmp1,this->get_y(),true))) {
HXLINE( 203)				goto _hx_goto_5;
            			}
HXLINE( 204)			this->set_x((this->get_x() - ( (Float)(1) )));
            		}
            		_hx_goto_5:;
HXLINE( 206)		while(true){
HXLINE( 206)			 ::openfl::display::Sprite _hx_tmp = this->mapCollision;
HXDLIN( 206)			Float _hx_tmp1 = this->get_x();
HXDLIN( 206)			if (!(_hx_tmp->hitTestPoint(_hx_tmp1,(this->get_y() + 30),true))) {
HXLINE( 206)				goto _hx_goto_6;
            			}
HXLINE( 207)			this->set_y((this->get_y() - ( (Float)(1) )));
            		}
            		_hx_goto_6:;
HXLINE( 209)		while(true){
HXLINE( 209)			 ::openfl::display::Sprite _hx_tmp = this->mapCollision;
HXDLIN( 209)			Float _hx_tmp1 = this->get_x();
HXDLIN( 209)			if (!(_hx_tmp->hitTestPoint(_hx_tmp1,(this->get_y() - ( (Float)(30) )),true))) {
HXLINE( 209)				goto _hx_goto_7;
            			}
HXLINE( 210)			this->set_y((this->get_y() + 1));
            		}
            		_hx_goto_7:;
HXLINE( 212)		bool _hx_tmp2;
HXDLIN( 212)		 ::openfl::display::Sprite _hx_tmp3 = this->mapCollision;
HXDLIN( 212)		Float _hx_tmp4 = this->get_x();
HXDLIN( 212)		if (_hx_tmp3->hitTestPoint(_hx_tmp4,(this->get_y() + 32),true)) {
HXLINE( 212)			_hx_tmp2 = (this->yspeed > 0);
            		}
            		else {
HXLINE( 212)			_hx_tmp2 = false;
            		}
HXDLIN( 212)		if (_hx_tmp2) {
HXLINE( 213)			this->onground = true;
HXLINE( 214)			this->dispatchEvent( ::engine::events::CharacterStateEvent_obj::__alloc( HX_CTX ,::engine::events::CharacterStateEvent_obj::ON_TOUCH_GROUND,null()));
HXLINE( 215)			this->yspeed = ( (Float)(0) );
            		}
HXLINE( 217)		 ::openfl::display::Sprite _hx_tmp5 = this->mapCollision;
HXDLIN( 217)		Float _hx_tmp6 = (this->get_x() + 32);
HXDLIN( 217)		if (_hx_tmp5->hitTestPoint(_hx_tmp6,this->get_y(),true)) {
HXLINE( 218)			this->onrightWall = true;
HXLINE( 219)			if ((this->xspeed > 0)) {
HXLINE( 219)				this->xspeed = ( (Float)(0) );
            			}
            		}
HXLINE( 221)		 ::openfl::display::Sprite _hx_tmp7 = this->mapCollision;
HXDLIN( 221)		Float _hx_tmp8 = (this->get_x() - ( (Float)(32) ));
HXDLIN( 221)		if (_hx_tmp7->hitTestPoint(_hx_tmp8,this->get_y(),true)) {
HXLINE( 222)			this->onleftWall = true;
HXLINE( 223)			if ((this->xspeed < 0)) {
HXLINE( 223)				this->xspeed = ( (Float)(0) );
            			}
            		}
HXLINE( 225)		Float _hx_tmp9 = this->get_x();
HXDLIN( 225)		this->set_x((_hx_tmp9 + this->xspeed));
HXLINE( 226)		Float _hx_tmp10 = this->get_y();
HXDLIN( 226)		this->set_y((_hx_tmp10 + this->yspeed));
            	}
...
void PlayerDefault_obj::jumpUp(Float power){
            	HX_GC_STACKFRAME(&_hx_pos_1b07d5ba1db1ad5b_228_jumpUp)
HXLINE( 229)		if ((this->jumpCount <= 0)) {
HXLINE( 230)			return;
            		}
HXLINE( 232)		this->state = ::engine::States_obj::FREE_dyn();
HXLINE( 233)		this->yspeed = power;
HXLINE( 234)		this->dispatchEvent( ::engine::events::CharacterStateEvent_obj::__alloc( HX_CTX ,::engine::events::CharacterStateEvent_obj::JUMP_UP,null()));
HXLINE( 235)		this->onground = false;
HXLINE( 236)		 ::engine::PlayerDefault _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 236)		_hx_tmp->jumpCount = (_hx_tmp->jumpCount - 1);
            	}
...
void PlayerDefault_obj::turnRight(){
            	HX_STACKFRAME(&_hx_pos_1b07d5ba1db1ad5b_239_turnRight)
...
void PlayerDefault_obj::turnLeft(){
            	HX_STACKFRAME(&_hx_pos_1b07d5ba1db1ad5b_242_turnLeft)
HXDLIN( 242)		this->set_scaleX(((Float)-0.3));
            	}

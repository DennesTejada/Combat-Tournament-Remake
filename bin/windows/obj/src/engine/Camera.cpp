...
HX_DEFINE_STACK_FRAME(_hx_pos_b19832cc837a7a1b_18_new,"engine.Camera","new",0xad1d1363,"engine.Camera.new","engine/Camera.hx",18,0xcb66214c)
HX_LOCAL_STACK_FRAME(_hx_pos_b19832cc837a7a1b_30_addedToStage,"engine.Camera","addedToStage",0xbcaae700,"engine.Camera.addedToStage","engine/Camera.hx",30,0xcb66214c)
HX_LOCAL_STACK_FRAME(_hx_pos_b19832cc837a7a1b_38_update,"engine.Camera","update",0x8923c6e6,"engine.Camera.update","engine/Camera.hx",38,0xcb66214c)
namespace engine{

void Camera_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b19832cc837a7a1b_18_new)
HXLINE(  24)		this->viewHeight = 480;
HXLINE(  23)		this->viewWidth = 800;
HXLINE(  27)		super::__construct();
HXLINE(  28)		this->addEventListener(HX_("addedToStage",63,22,55,0c),this->addedToStage_dyn(),null(),null(),null());
            	}
...
void Camera_obj::addedToStage( ::openfl::events::Event e){
            	HX_GC_STACKFRAME(&_hx_pos_b19832cc837a7a1b_30_addedToStage)
HXLINE(  32)		this->bitmapDataView =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,800,480,false,null());
HXLINE(  33)		this->bitmapView =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,this->bitmapDataView,null(),null());
HXLINE(  35)		this->stage->addChild(this->bitmapView);
HXLINE(  36)		::Main_obj::gameLoop->addEventListener(::engine::events::GameEvent_obj::ON_GAME_LOOP,this->update_dyn(),null(),null(),null());
            	}
...
void Camera_obj::update( ::engine::events::GameEvent e){
            	HX_GC_STACKFRAME(&_hx_pos_b19832cc837a7a1b_38_update)
HXLINE(  39)		 ::openfl::geom::Matrix matrix =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE(  41)		Float _hx_tmp = -(this->get_x());
HXDLIN(  41)		Float _hx_tmp1 = (( (Float)(this->viewWidth) ) / ( (Float)(2) ));
HXDLIN(  41)		matrix->tx = (_hx_tmp + (_hx_tmp1 * this->get_scaleX()));
HXLINE(  43)		Float _hx_tmp2 = -(this->get_y());
HXDLIN(  43)		Float _hx_tmp3 = (( (Float)(this->viewHeight) ) / ( (Float)(2) ));
HXDLIN(  43)		matrix->ty = (_hx_tmp2 + (_hx_tmp3 * this->get_scaleY()));
HXLINE(  45)		Float _hx_tmp4 = (( (Float)(1) ) / this->get_scaleX());
HXDLIN(  45)		matrix->scale(_hx_tmp4,(( (Float)(1) ) / this->get_scaleY()));
HXLINE(  47)		this->parent->set_visible(true);
HXLINE(  49)		this->bitmapDataView->draw(this->parent,matrix,null(),null(),null(),null());
HXLINE(  51)		this->parent->set_visible(false);
HXLINE(  52)		if (::hx::IsNotNull( this->target )) {
HXLINE(  53)			this->set_x(this->target->get_x());
HXLINE(  54)			this->set_y(this->target->get_y());
            		}
            	}

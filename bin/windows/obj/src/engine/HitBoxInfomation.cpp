...
HX_DEFINE_STACK_FRAME(_hx_pos_f9e91d5617a4e528_8_new,"engine.HitBoxInfomation","new",0x99fe71ec,"engine.HitBoxInfomation.new","engine/HitBoxInfomation.hx",8,0xb1b3d3a3)
namespace engine{

void HitBoxInfomation_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f9e91d5617a4e528_8_new)
HXLINE(  16)		this->isLauncher = false;
HXLINE(  14)		this->damage = ((Float)0);
HXLINE(  13)		this->gravity = ((Float).5);
HXLINE(  12)		this->friction = ((Float).8);
HXLINE(  11)		this->yspeed = ((Float)0);
HXLINE(  10)		this->xspeed = ((Float)0);
            	}

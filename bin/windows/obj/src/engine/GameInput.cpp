...
HX_DEFINE_STACK_FRAME(_hx_pos_f74bffafb0b300d8_11_new,"engine.GameInput","new",0xa186f1de,"engine.GameInput.new","engine/GameInput.hx",11,0xb262f0d3)
HX_LOCAL_STACK_FRAME(_hx_pos_f74bffafb0b300d8_38_key_down,"engine.GameInput","key_down",0xf4880004,"engine.GameInput.key_down","engine/GameInput.hx",38,0xb262f0d3)
HX_LOCAL_STACK_FRAME(_hx_pos_f74bffafb0b300d8_81_key_up,"engine.GameInput","key_up",0x43ebe17d,"engine.GameInput.key_up","engine/GameInput.hx",81,0xb262f0d3)
namespace engine{

void GameInput_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f74bffafb0b300d8_11_new)
HXLINE(  30)		this->JUMP = false;
HXLINE(  29)		this->BLOCK = false;
HXLINE(  28)		this->SPECIAL = false;
HXLINE(  27)		this->ATTACK = false;
HXLINE(  26)		this->RIGHT = false;
HXLINE(  25)		this->LEFT = false;
HXLINE(  24)		this->DOWN = false;
HXLINE(  23)		this->UP = false;
HXLINE(  21)		this->BIND_JUMP = 32;
HXLINE(  20)		this->BIND_BLOCK = 68;
HXLINE(  19)		this->BIND_SPECIAL = 83;
HXLINE(  18)		this->BIND_ATTACK = 65;
HXLINE(  17)		this->BIND_RIGHT = 39;
HXLINE(  16)		this->BIND_LEFT = 37;
HXLINE(  15)		this->BIND_DOWN = 40;
HXLINE(  14)		this->BIND_UP = 38;
HXLINE(  34)		super::__construct();
HXLINE(  35)		this->addEventListener(HX_("keyDown",a1,69,47,9c),this->key_down_dyn(),null(),null(),null());
HXLINE(  36)		this->addEventListener(HX_("keyUp",da,b9,fe,de),this->key_up_dyn(),null(),null(),null());
            	}
...
void GameInput_obj::key_down( ::openfl::events::KeyboardEvent e){
            	HX_STACKFRAME(&_hx_pos_f74bffafb0b300d8_38_key_down)
HXLINE(  39)		if ((e->keyCode == this->BIND_UP)) {
HXLINE(  40)			this->UP = true;
            		}
HXLINE(  42)		if ((e->keyCode == this->BIND_DOWN)) {
HXLINE(  43)			this->DOWN = true;
            		}
HXLINE(  45)		if ((e->keyCode == this->BIND_LEFT)) {
HXLINE(  46)			this->LEFT = true;
            		}
HXLINE(  48)		if ((e->keyCode == this->BIND_RIGHT)) {
HXLINE(  49)			this->RIGHT = true;
            		}
HXLINE(  51)		if ((e->keyCode == this->BIND_ATTACK)) {
HXLINE(  52)			this->ATTACK = true;
            		}
HXLINE(  54)		if ((e->keyCode == this->BIND_SPECIAL)) {
HXLINE(  55)			this->SPECIAL = true;
            		}
HXLINE(  57)		if ((e->keyCode == this->BIND_BLOCK)) {
HXLINE(  58)			this->BLOCK = true;
            		}
HXLINE(  60)		if ((e->keyCode == this->BIND_JUMP)) {
HXLINE(  61)			this->JUMP = true;
            		}
HXLINE(  66)		if ((e->keyCode == 112)) {
HXLINE(  67)			::Global_obj::restart();
HXLINE(  68)			::Global_obj::gameServer->createServer(null(),null());
            		}
HXLINE(  71)		if ((e->keyCode == 113)) {
HXLINE(  73)			 ::Dynamic this1 =  ::Dynamic(::hx::Anon_obj::Create(0));
HXDLIN(  73)			 ::Dynamic data = this1;
HXLINE(  74)			{
HXLINE(  74)				 ::Dynamic value = (HX_("player",61,eb,b8,37) + ::hx::Mod(::Math_obj::random(),999));
HXDLIN(  74)				{
HXLINE(  74)					 ::Dynamic this2 = data;
HXDLIN(  74)					if (::hx::IsNotNull( this2 )) {
HXLINE(  74)						::Reflect_obj::setProperty(this2,HX_("username",16,86,eb,20),value);
            					}
            				}
            			}
HXLINE(  75)			{
HXLINE(  75)				 ::Dynamic this3 = data;
HXDLIN(  75)				if (::hx::IsNotNull( this3 )) {
HXLINE(  75)					::Reflect_obj::setProperty(this3,HX_("character",a9,db,d1,41),HX_("Slaptastic",90,66,1e,bb));
            				}
            			}
HXLINE(  76)			::Global_obj::gameClient->localPlayerInfo = data;
HXLINE(  78)			::Global_obj::gameClient->joinServer(HX_("127.0.0.1",fd,bc,5e,a1),9000);
            		}
            	}
...
void GameInput_obj::key_up( ::openfl::events::KeyboardEvent e){
            	HX_STACKFRAME(&_hx_pos_f74bffafb0b300d8_81_key_up)
HXLINE(  82)		if ((e->keyCode == this->BIND_UP)) {
HXLINE(  83)			this->UP = false;
            		}
HXLINE(  85)		if ((e->keyCode == this->BIND_DOWN)) {
HXLINE(  86)			this->DOWN = false;
            		}
HXLINE(  88)		if ((e->keyCode == this->BIND_LEFT)) {
HXLINE(  89)			this->LEFT = false;
            		}
HXLINE(  91)		if ((e->keyCode == this->BIND_RIGHT)) {
HXLINE(  92)			this->RIGHT = false;
            		}
HXLINE(  94)		if ((e->keyCode == this->BIND_ATTACK)) {
HXLINE(  95)			this->ATTACK = false;
            		}
HXLINE(  97)		if ((e->keyCode == this->BIND_SPECIAL)) {
HXLINE(  98)			this->SPECIAL = false;
            		}
HXLINE( 100)		if ((e->keyCode == this->BIND_BLOCK)) {
HXLINE( 101)			this->BLOCK = false;
            		}
HXLINE( 103)		if ((e->keyCode == this->BIND_JUMP)) {
HXLINE( 104)			this->JUMP = false;
            		}
            	}

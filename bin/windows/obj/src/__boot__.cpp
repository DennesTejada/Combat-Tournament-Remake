...
::swf::exporters::core::FilterType_obj::__register();
::swf::exporters::animate::AnimateShapeCommand_obj::__register();
...
::engine::States_obj::__register();
::ValueType_obj::__register();
::sys::net::Host_obj::__register();
::swf::exporters::animate::AnimateLibrary_obj::__register();
...
::engine::events::NetworkEvent_obj::__register();
::engine::events::GameEvent_obj::__register();
::engine::events::CharacterStateEvent_obj::__register();
...
::swf::exporters::animate::_AnimateTimeline::FrameSymbolInstance_obj::__register();
::swf::exporters::animate::AnimateTimeline_obj::__register();
::swf::exporters::animate::AnimateStaticTextSymbol_obj::__register();
::swf::exporters::animate::AnimateSpriteSymbol_obj::__register();
::swf::exporters::animate::AnimateShapeSymbol_obj::__register();
::swf::exporters::animate::AnimateFrameObject_obj::__register();
::swf::exporters::animate::AnimateFrame_obj::__register();
::swf::exporters::animate::AnimateFontSymbol_obj::__register();
::swf::exporters::animate::AnimateDynamicTextSymbol_obj::__register();
::swf::exporters::animate::AnimateButtonSymbol_obj::__register();
::swf::exporters::animate::AnimateBitmapSymbol_obj::__register();
::swf::exporters::animate::AnimateSymbol_obj::__register();
::slaptastic_fla::Sprite371_13_obj::__register();
::slaptastic_fla::Sprite365_4_obj::__register();
::slaptastic_fla::Sprite356_3_obj::__register();
::slaptastic_fla::Sprite354_2_obj::__register();
...
::engine::HitBoxInfomation_obj::__register();
::engine::GameLoop_obj::__register();
::engine::GameInput_obj::__register();
::engine::Camera_obj::__register();
::cpp::Lib_obj::__register();
::client::ClientInput_obj::__register();
::characters::SlaptasticGameplay_obj::__register();
::engine::PlayerDefault_obj::__register();
::Type_obj::__register();
::Sys_obj::__register();
::StringTools_obj::__register();
::StringBuf_obj::__register();
::Std_obj::__register();
::Slaptastic_obj::__register();
::Reflect_obj::__register();
::ManifestResources_obj::__register();
::Lambda_obj::__register();
::HitBox_obj::__register();
::server::ServerMain_obj::__register();
::client::ClientMain_obj::__register();
::GameScene_obj::__register();
::Game_obj::__register();
::EReg_obj::__register();
::Date_obj::__register();
::BoxStage_obj::__register();
...
::swf::exporters::core::FilterType_obj::__boot();
::swf::exporters::animate::AnimateShapeCommand_obj::__boot();
...
::engine::events::CharacterStateEvent_obj::__boot();
::engine::events::GameEvent_obj::__boot();
::engine::events::NetworkEvent_obj::__boot();
...
::swf::exporters::animate::AnimateLibrary_obj::__boot();

...
HXLINE(  80)		{
HXLINE(  80)			::String v = (::ManifestResources_obj::rootPath + HX_("lib/Slaptastic.zip",cd,a8,8d,9c));
HXDLIN(  80)			::lime::utils::Assets_obj::bundlePaths->set(HX_("Slaptastic",90,66,1e,bb),v);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v1 = (::ManifestResources_obj::rootPath + HX_("lib/Box.zip",d4,96,0d,ce));
HXDLIN(  81)			::lime::utils::Assets_obj::bundlePaths->set(HX_("Box",eb,75,32,00),v1);
            		}
HXLINE(  67)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("Slaptastic",90,66,1e,bb));
HXLINE(  85)		if (::hx::IsNotNull( library )) {
HXLINE(  85)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  86)			::ManifestResources_obj::preloadLibraryNames->push(HX_("Slaptastic",90,66,1e,bb));
            		}
HXLINE(  87)		library = ::lime::utils::Assets_obj::getLibrary(HX_("Box",eb,75,32,00));
HXLINE(  88)		if (::hx::IsNotNull( library )) {
HXLINE(  88)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  89)			::ManifestResources_obj::preloadLibraryNames->push(HX_("Box",eb,75,32,00));
            		}
            	}

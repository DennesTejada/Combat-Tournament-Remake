...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_30_createMatch,"Main","createMatch",0x2ba53914,"Main.createMatch","Main.hx",30,0x087e5c05)

void Main_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_20_new)
HXLINE(  21)		super::__construct();
HXLINE(  22)		::Main_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  24)		::Main_obj::gameLoop =  ::engine::GameLoop_obj::__alloc( HX_CTX );
HXLINE(  25)		this->stage->addChild(::Main_obj::gameLoop);
HXLINE(  27)		::Main_obj::gameInput =  ::engine::GameInput_obj::__alloc( HX_CTX );
HXLINE(  28)		this->stage->addChild(::Main_obj::gameInput);
            	}
...
void Main_obj::createMatch(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_30_createMatch)
HXLINE(  31)		this->scene =  ::GameScene_obj::__alloc( HX_CTX );
HXLINE(  32)		this->addChild(this->scene);
HXLINE(  33)		::Main_obj::gameLoop->resetTime();
            	}

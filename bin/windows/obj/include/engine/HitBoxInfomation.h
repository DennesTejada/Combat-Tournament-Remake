...
HX_DECLARE_STACK_FRAME(_hx_pos_f9e91d5617a4e528_8_new)
...
{
            	HX_STACKFRAME(&_hx_pos_f9e91d5617a4e528_8_new)
HXLINE(  16)		( ( ::engine::HitBoxInfomation)(__this) )->isLauncher = false;
HXLINE(  14)		( ( ::engine::HitBoxInfomation)(__this) )->damage = ((Float)0);
HXLINE(  13)		( ( ::engine::HitBoxInfomation)(__this) )->gravity = ((Float).5);
HXLINE(  12)		( ( ::engine::HitBoxInfomation)(__this) )->friction = ((Float).8);
HXLINE(  11)		( ( ::engine::HitBoxInfomation)(__this) )->yspeed = ((Float)0);
HXLINE(  10)		( ( ::engine::HitBoxInfomation)(__this) )->xspeed = ((Float)0);
            	}

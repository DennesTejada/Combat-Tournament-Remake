...
class HXCPP_CLASS_ATTRIBUTES Timeline_obj : public ::hx::Object
{
	...
	public:
		...
		virtual void attachMovieClip( ::openfl::display::MovieClip movieClip);
		::Dynamic attachMovieClip_dyn();

		virtual void enterFrame(int frame);
		::Dynamic enterFrame_dyn();

		virtual void initializeSprite( ::openfl::display::Sprite sprite);

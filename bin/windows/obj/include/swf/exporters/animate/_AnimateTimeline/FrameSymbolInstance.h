...
#define INCLUDED_swf_exporters_animate__AnimateTimeline_FrameSymbolInstance
...
class HXCPP_CLASS_ATTRIBUTES FrameSymbolInstance_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="swf.exporters.animate._AnimateTimeline.FrameSymbolInstance")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"swf.exporters.animate._AnimateTimeline.FrameSymbolInstance"); }
...
#endif /* INCLUDED_swf_exporters_animate__AnimateTimeline_FrameSymbolInstance */ 

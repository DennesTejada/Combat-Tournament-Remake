...
#define INCLUDED_swf_exporters_animate_AnimateBitmapSymbol
...
class HXCPP_CLASS_ATTRIBUTES AnimateBitmapSymbol_obj : public  ::swf::exporters::animate::AnimateSymbol_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x354f6af7 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="swf.exporters.animate.AnimateBitmapSymbol")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"swf.exporters.animate.AnimateBitmapSymbol"); }
...
#endif /* INCLUDED_swf_exporters_animate_AnimateBitmapSymbol */ 

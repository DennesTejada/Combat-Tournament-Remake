...
class CharacterStateEvent extends Event
{
	...
	static public var ON_BLOCK_ATTACK:String = "ON_BLOCK_ATTACK";
	static public var ON_BLOCK_DIRECTION:String = "ON_BLOCK_DIRECTION";
	static public var ON_BEFORE_GETTING_HIT:String = "ON_BEFORE_GETTING_HIT";

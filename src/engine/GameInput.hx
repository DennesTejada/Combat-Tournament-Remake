...
class GameInput extends Sprite
{
	...
	public var BIND_UP:Int = Keyboard.UP;
	public var BIND_DOWN:Int = Keyboard.DOWN;
	public var BIND_LEFT:Int = Keyboard.LEFT;
	public var BIND_RIGHT:Int = Keyboard.RIGHT;
	public var BIND_ATTACK:Int = Keyboard.A;
	public var BIND_SPECIAL:Int = Keyboard.S;
	public var BIND_BLOCK:Int = Keyboard.D;
	public var BIND_JUMP:Int = Keyboard.SPACE;
	//player1 key
